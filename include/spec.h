...
inline extern std::string const _BREW_DEFAULT_PATH_X86_64{"/usr/local/bin/brew"};
inline extern std::string const _BREW_DEFAULT_PATH_ARM64{"/opt/homebrew/bin/brew"};
} // namespace BrewSpec
